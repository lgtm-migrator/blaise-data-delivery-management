...
describe("React homepage", () => {
    ...
    const batches = [
        {date: "2021-03-24T11:30:00.000Z", dateString: "24/03/2021", name: "24032021_113000"},
        {date: "2021-03-12T02:30:00.000Z", dateString: "12/03/2021", name: "12032021_023000"}
    ];
    ...
    it("should render correctly", async () => {
        ...
        await waitFor(() => {
            expect(getByText(/Data Delivery Management/i)).toBeDefined();
            expect(getByText(/24\/03\/2021 11:30/i)).toBeDefined();
            expect(getByText(/12\/03\/2021 02:30/i)).toBeDefined();
            expect(queryByText(/Loading/i)).not.toBeInTheDocument();
        });
